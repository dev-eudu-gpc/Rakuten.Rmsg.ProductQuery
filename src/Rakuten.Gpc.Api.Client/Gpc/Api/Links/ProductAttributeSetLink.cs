// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="ProductAttributeSetLink.cs" company="Rakuten">
...
namespace Rakuten.Gpc.Api.Links
{
    ...
    /// </summary>
    [LinkRelation(Name = "http://rels.rakuten.com/product-attribute-set")]
    public class ProductAttributeSetLink : LinkTemplate
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProductAttributeSetLink"/> class.
        /// </summary>
        /// <param name="target">The location of the product attribute set this link points to.</param>
        public ProductAttributeSetLink(IUriTemplate target) : base(target)
        {
        ...
        /// <param name="target">The location of the product attribute set this link points to.</param>
        public ProductAttributeSetLink(string relationType, IUriTemplate target) : base(relationType, target)
        {
            Contract.Requires(target != null);
        }
        ...
        public ProductAttributeSetLink(string relationType, IUriTemplate target, ITargetAttributes attributes)
        ...
        public ProductAttributeSetLink ForId(string id)
        {
            var resolvedTemplate = this.Target.Bind("id", id);
            Contract.Assume(resolvedTemplate != null);

            return new ProductAttributeSetLink(this.RelationType, resolvedTemplate, this.TargetAttributes);
        }
        ...
        public ProductAttributeSetLink ForCulture(CultureInfo culture)
        {
            var resolvedTemplate = this.Target.Bind("culture", culture == null ? null : culture.Name);
            Contract.Assume(resolvedTemplate != null);

            return new ProductAttributeSetLink(
                this.RelationType,
                resolvedTemplate,
