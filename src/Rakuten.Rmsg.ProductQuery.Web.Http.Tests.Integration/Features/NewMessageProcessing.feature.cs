...
namespace Rakuten.Rmsg.ProductQuery.Web.Http.Tests.Integration.Features
{
    ...
    public partial class NewMessageProcessingFeature
    {
        ...
        public static void FeatureSetup(Microsoft.VisualStudio.TestTools.UnitTesting.TestContext testContext)
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "NewMessageProcessing", "Ensures the processing of new messages on the queue", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        public virtual void AQueryFileWithASingleValidProductIsProcessedCorrectly()
        {
            ...
            testRunner.When("the message queue is empty once again", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "When ");
            testRunner.And("the product query is retrieved from the database", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            testRunner.And("the file is retrieved from storage", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
            testRunner.Then("the items in the database match the items in the file", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
            testRunner.And("the status of the product query from the database is completed", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
        ...
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestMethodAttribute()]
        [Microsoft.VisualStudio.TestTools.UnitTesting.DescriptionAttribute("Files with some rows having GTINs and others not are processed correctly")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestPropertyAttribute("FeatureTitle", "NewMessageProcessing")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("GpcCoreApi")]
        [Microsoft.VisualStudio.TestTools.UnitTesting.TestCategoryAttribute("WebJob")]
        public virtual void FilesWithSomeRowsHavingGTINsAndOthersNotAreProcessedCorrectly()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Files with some rows having GTINs and others not are processed correctly", new string[] {
                        "GpcCoreApi",
                        "WebJob"});
            this.ScenarioSetup(scenarioInfo);
            this.ScenarioCleanup();
