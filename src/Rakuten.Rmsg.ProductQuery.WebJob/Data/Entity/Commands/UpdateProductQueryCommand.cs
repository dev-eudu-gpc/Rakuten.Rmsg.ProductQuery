...
namespace Rakuten.Rmsg.ProductQuery.WebJob
{
    ...
    internal class UpdateProductQueryCommand
    {
        ...
        /// <param name="status">The <see cref="ProductQueryStatus"/> that represents the completed status.</param>
        /// <param name="id">The unique identifier given to this query.</param>
        /// <returns>A <see cref="Task"/> the represents the asynchronous operation.</returns>
        public static async Task Execute(ProductQueryContext context, ProductQueryStatus status, Guid id)
        {
