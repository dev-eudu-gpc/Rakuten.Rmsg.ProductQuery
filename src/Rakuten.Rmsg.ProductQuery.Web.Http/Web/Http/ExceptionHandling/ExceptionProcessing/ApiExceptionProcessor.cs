// ---------------------------------------------------------------------------------------------------------------------
// <copyright file="ApiExceptionProcessor.cs" company="Rakuten">
...
namespace Rakuten.Gpc.Api.Web.Http.ExceptionHandling
{
    ...
    /// <summary>
    /// Processes <see cref="ApiException"/>s.
    /// </summary>
    public class ApiExceptionProcessor : ExceptionProcessor
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiExceptionProcessor"/> class.
        /// </summary>
        ...
        public override bool CanProcess(Exception exception)
        {
            ...
            return exception is IApiException;
        }
            ...
            IEnumerable<MediaTypeFormatter> formatters)
        {
            ...
            if (!ExceptionProcessor.TryCreateProblemType(exception, this.problemTypeFactory, out type))
            {
                return null;
            }
